use crate::{SparseDecorator, SparseRepresentation};
use burn_tensor::{
    backend::Backend,
    ops::{
        ActivationOps, BoolTensor, BoolTensorOps, Conv1dBackward, ConvOptions,
        ConvTransposeOptions, FloatTensor, FloatTensorOps, IntElem, IntTensor, IntTensorOps,
    ...
    R: SparseRepresentation,
{
    fn float_from_data<const D: usize>(
        data: burn_tensor::Data<burn_tensor::ops::FloatElem<B>, D>,
    ...
    R: SparseRepresentation,
{
    ...
    ) -> Reader<Data<IntElem<SparseDecorator<B, R>>, D>> {
        B::int_into_data(tensor)
    }

    fn int_from_data<const D: usize>(
        data: Data<IntElem<SparseDecorator<B, R>>, D>,
        device: &Device<SparseDecorator<B, R>>,
    ) -> IntTensor<SparseDecorator<B, R>, D> {
